...
async function main() {
  ...
  let text: string = await load_file_text("https://projects.fivethirtyeight.com/march-madness-api/2022/fivethirtyeight_ncaa_forecasts.csv")//.//fivethirtyeight_ncaa_forecasts.csv")
